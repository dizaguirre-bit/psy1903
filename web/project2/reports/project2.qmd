...
ggsave("D-score Histogram.png", dscore_histogram, path = here::here("outputs", "plots"))
ggsave("RT Barplot.png", rt_barplot, path = here::here("outputs", "plots"))
ggsave("D-score & Anxiety Scatter Plot.png", d_anx_scatter, path = here::here("outputs", "plots"))
